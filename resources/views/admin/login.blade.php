    ...
    <div class="container">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 d-flex flex-column mx-auto">
            ...
            <div class="card-header pb-0 text-left bg-transparent">
                <h3 class="font-weight-bolder" style="color:  #4b0082;">Welcome back Admin</h3>
            ...
            <div class="card-body">
                ...
                <div class="text-center">
                    <button type="submit" class="btn bg-gradient-primary w-100 mt-4 mb-0" style="background-color: #4b0082;">Sign in</button>
                </div>
                </form>
            </div>
            </div>
